        ...
        <article>
          ...
          <section>
            <p className="text-base text-justify">
              ...
              chuyên ngành Thiết Kế Trang Web tại Trường Cao Đẳng Công Nghệ
              Thông Tin TP.HCM (ITC). Với niềm đam mê sâu sắc với lập trình và
              sáng tạo giao diện, tớ không ngừng học hỏi và phát triển kỹ năng
              mỗi ngày. Tớ còn tự học thêm về Editor và thiết kế nữa. Hiện tại,
              tớ đang từng bước chinh phục hành trình và trở thành một Fullstack
              Developer chuyên nghiệp, thực hiện những ước mơ to lớn và đóng góp
              giá trị cho các dự án công nghệ trong tương lai.
            </p>
          </section>
          <Border />
          <Hero />
