...
const Hero = () => {
  return (
    <div className="hero-container flex justify-center my-10">
      <svg
        id="svg-global"
      ...
      >
        ...
        <g id="particles">
          {[
            { id: "p1", cx: 43.5482, cy: 30.6778, r: 1.8802 },
            { id: "p2", cx: 50.0323, cy: 46.4717, r: 1.8802 },
            { id: "p3", cx: 40.3062, cy: 61.1374, r: 1.5042 },
            { id: "p4", cx: 50.7527, cy: 71.2906, r: 2.6323 },
            { id: "p5", cx: 48.5913, cy: 75.8031, r: 1.1281 },
            { id: "p6", cx: 52.9153, cy: 66.7781, r: 0.376 },
            { id: "p7", cx: 52.1936, cy: 42.7113, r: 1.1281 },
            { id: "p8", cx: 57.2367, cy: 28.4216, r: 1.1281 },
            { id: "p9", cx: 43.9084, cy: 34.0623, r: 0.7521 },
          ].map((particle) => (
            <path
              key={particle.id}
              fill={`url(#paint${
                ["3", "4", "5", "6", "7", "8", "9", "10", "11"][
                  parseInt(particle.id.slice(1)) - 1
                ]
              }_linear_204_217)`}
              d={`M${particle.cx} ${particle.cy - particle.r}C${
                particle.cx + particle.r
              } ${particle.cy - particle.r} ${particle.cx + particle.r} ${
                particle.cy
              } ${particle.cx} ${particle.cy}C${particle.cx - particle.r} ${
                particle.cy
              } ${particle.cx - particle.r} ${particle.cy - particle.r} ${
                particle.cx
              } ${particle.cy - particle.r}Z`}
        ...
        {/* Right panel */}
        <g id="panel-right">
          <mask id="path-26-inside-1_204_217" fill="white">
          ...
          <mask id="path-28-inside-2_204_217" fill="white">
        ...
        <defs>
          {[
            ...
            <linearGradient
              key={gradient.id}
              id={`${gradient.id}_linear_204_217`}
              ...
              y2={gradient.y2}
            >
              <stop stopColor={gradient.colors[0]} />
              <stop
                offset="1"
                stopColor={gradient.colors[1]}
                stopOpacity={gradient.stopOpacity || 1}
              />
              {gradient.colors[2] && (
                <stop offset="0.29" stopColor={gradient.colors[2]} />
              )}
            </linearGradient>
          ))}
        </defs>
