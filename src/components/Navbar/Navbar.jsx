  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-20 lg:px-[4rem] px-[1.4rem] py-[1.2rem]"
        ...
        >
          ...
          <nav className="sm-desktop-menu">
            {items.map((it, idx) => (
              <Link key={idx} to={it.link} className="sm-desktop-item">
                {it.label}
              </Link>
            ))}
          </nav>
